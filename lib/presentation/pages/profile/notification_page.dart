                          ...
                          itemBuilder: (context, index) {
                            return InkWell(
                              onTap: () async {
                                ...
                                } else if (state.notifications[index].blogData != null) {
                                    final url = "${AppConstants.webUrl}/blog/${state.notifications[index].blogData?.uuid}";
                                    await launchUrl(
                                      Uri.parse(url),
                                      mode: LaunchMode.externalApplication,
                                    );
                                  } else if (state.notifications[index].type == "reservation") {
                                    final url = "${AppConstants.webUrl}/reservations";
                                    await launchUrl(
                                      Uri.parse(url),
                                      mode: LaunchMode.externalApplication,
                                    );
